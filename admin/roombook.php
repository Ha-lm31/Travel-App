        ...
        <form action="" method="POST" class="guestdetailpanelform">
            ...
            <div class="middle">
                <div class="guestinfo">
                    ...
                    <?php
                    $countries = array("mostaganem","oran","alger","tlmcen");
                    ?>
                ...
                <div class="reservationinfo">
                    ...
                    <div class="form-group">
                        ...
                        <select name="num_persons" class="selectinput" required>
        ...
        <?php       
            if (isset($_POST['guestdetailsubmit'])) {
                ...
                if($Name == "" || $Email == "" || $Country == ""){
                    ...
                    $sta = "NotConfirm";
                    $sql = "INSERT INTO roombook(Name,Email,Country,Phone,RoomType,Bed,NoofRoom,Meal,cin,cout,stat,nodays,num_persons) VALUES ('$Name','$Email','$Country','$Phone','$RoomType','$Bed','$NoofRoom','$Meal','$cin','$cout','$sta',datediff('$cout','$cin'),'$num_persons')";
        ...
        <table class="table table-bordered" id="table-data">
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $res['num_persons'] ?></td>
